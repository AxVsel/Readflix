...
<a href="discoveruser.php" class="w3-card-4 w3-margin-right w3-blue w3-margin-top w3-button w3-border w3-hover-red" style="width:23%">
  <header class="w3-container w3-light-grey">
      <h3>Pembayaran Selesai</h3>
    </header>
    <img src="imglangganan/books-mood-photo-hd-wallpaper.jpg" alt="Alps" style="width:100%">
    <div class="w3-container w3-center">
      <p>Silahkan Menuju ke Halaman Beranda</p>
