...
<div class="w3-card-4  w3-display-middle" style="width: 40%;">
  ...
  <form class="w3-container" method="POST" action="adminphp/login.php">
    <p>      
   ...
   <!--  <p> 
    ...
    <p><b><a href="registeradmin.php" style="color: blue;">Register</a></b></p>
     <div class="error">
        <p>Silahkan Masukan Username dan Passwword Dengan Benar</p>
      </div>
    <p>
